...
extern "C"
{
    ...
    Java_com_ming_opencvdepth_MainActivity_version(
            JNIEnv *env,
            jobject) {
    ...
    JNICALL Java_com_ming_opencvdepth_MainActivity_rgba2bgra
            (
                    JNIEnv *env,
                    jobject obj,
                    jint w,
    ...
    JNIEXPORT jbyteArray
    JNICALL Java_com_ming_opencvdepth_MainActivity_rgba2gray
            (
                    JNIEnv *env,
                    jobject obj,
                    jint w,
    ...
    JNIEXPORT jbyteArray
    JNICALL Java_com_ming_opencvdepth_MainActivity_gray2rgba
            (
                    JNIEnv *env,
                    jobject obj,
                    jint w,
    ...
    JNIEXPORT jbyteArray
    JNICALL Java_com_ming_opencvdepth_MainActivity_disparity
            (
                    JNIEnv *env,
                    jobject obj,
                    jint w,
